...
const WalletCard = ({ balance, currency, trend, trendPercentage }) => {
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-3">
          <div className="flex-1">
            <p className="text-xs font-caption text-white/80 mb-1 uppercase tracking-wider">Available Balance</p>
        ...
        <div className="flex items-center gap-2 pt-3 border-t border-white/20">
          ...
          <span className="text-xs text-white/70 font-caption">vs last month</span>
        </div>
      </div>
    </div>
  );
